    ...
    <main className="pt-32 pb-20 max-w-[1600px] mx-auto px-8 flex gap-12">
      ...
      <aside className="w-64 flex-shrink-0 hidden lg:block">
        <div className="sticky top-32 space-y-10">
          <div>
            <h3 className="font-sans text-xs uppercase tracking-widest text-primary/60 mb-6">Cue Type</h3>
            <div className="space-y-4">
              {['Pool', 'Snooker', 'Carom'].map(type => (
          ...
          <div>
            <h3 className="font-sans text-xs uppercase tracking-widest text-primary/60 mb-6">Price Range</h3>
          ...
          <div>
            <h3 className="font-sans text-xs uppercase tracking-widest text-primary/60 mb-6">Brand</h3>
            <div className="space-y-4">
          ...
          <div>
            <h3 className="font-sans text-xs uppercase tracking-widest text-primary/60 mb-6">Weight</h3>
      ...
      <section className="flex-grow">
        <div className="mb-12 flex justify-between items-end">
          <div>
            <span className="font-sans text-xs uppercase tracking-widest text-secondary mb-2 block">The Collection</span>
            <h1 className="serif text-5xl text-on-surface font-bold leading-tight">Master Artisan Cues</h1>
          </div>
          <div className="flex items-center gap-4 text-xs font-sans text-on-surface-variant">
            <span>Showing {PRODUCTS.length} of 84 results</span>
              ...
              <Link to={`/product/${product.id}`}>
                <div className="aspect-[3/4] overflow-hidden rounded-lg bg-surface-container-low mb-6 relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                    <button className="w-full bg-secondary text-on-secondary py-4 rounded-lg font-sans text-xs uppercase tracking-widest font-bold shadow-xl active:scale-95 transition-all">Add to Cart</button>
                  </div>
                </div>
